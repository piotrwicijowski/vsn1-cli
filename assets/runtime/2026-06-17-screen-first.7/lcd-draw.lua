...
if l=="f" then self:ldrrf(18,78,302,162,12,{64,160,255})self:ldft(z.f.a,26,111,24,{255,255,255})self:ldsw()return end
if l=="s" then self:ldrrf(18,78,302,162,12,{255,255,255})self:ldft(z.s.m,26,111,24,{0,0,0})self:ldsw()return end
