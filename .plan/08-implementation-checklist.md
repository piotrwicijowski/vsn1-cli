...
- Last verification run: `cargo fmt --check`, `cargo test`, `cargo check` (pass on 2026-06-26 after consolidating the bundled media runtime into one shared /vsn1_media_runtime.lua module, making 00.cfg explicitly re-export set_field/activate_layer for immediate screen commands, and keeping 08.cfg as a thin draw shim over the shared module)`
